<template>
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    <defs>
      ...
      <symbol id="wechat-icon" viewBox="0 0 24 24">
        <path fill="currentColor"
          d="M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 0 1 .213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 0 0 .167-.054l1.903-1.114a.864.864 0 0 1 .717-.098 10.16 10.16 0 0 0 2.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 4.882-1.932 7.621-.896-.302-3.938-3.88-7.012-8.312-7.012zM5.785 5.991c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178A1.17 1.17 0 0 1 4.623 7.17c0-.651.52-1.18 1.162-1.18zm5.813 0c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178 1.17 1.17 0 0 1-1.162-1.178c0-.651.52-1.18 1.162-1.18zm5.696 2.867c-1.797-.052-3.746.512-5.28 1.786-1.72 1.427-2.687 3.72-1.78 6.22.942 2.527 3.666 4.054 6.884 4.054.826 0 1.622-.12 2.361-.336a.722.722 0 0 1 .597.082l1.584.926a.272.272 0 0 0 .14.046c.134 0 .24-.111.24-.247 0-.06-.023-.12-.038-.177l-.324-1.233a.49.49 0 0 1 .18-.56C22.33 16.22 23.5 14.44 23.5 12.5c0-2.228-1.786-3.642-4.206-3.642zM16.9 9.235c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.969-.982zm4.819 0c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.969-.982z" />
      </symbol>
    </defs>
  </svg>
</template>
